...
#ifndef CONFIG_APDS9960C_TRIGGER
	apds9960_setup_int(config, true);

#ifdef CONFIG_APDS9960C_ENABLE_ALS
...
static int apds9960_sensor_setup(const struct device *dev)
{
	...
	if (!((chip_id == APDS9960_ID_1) || (chip_id == APDS9960_ID_2) || (chip_id == APDS9960_ID_3))) {
...
static const struct apds9960_config apds9960_config = {
...
#if CONFIG_APDS9960C_PGAIN_8X
	.pgain = APDS9960_PGAIN_8X,
#elif CONFIG_APDS9960C_PGAIN_4X
	.pgain = APDS9960_PGAIN_4X,
#elif CONFIG_APDS9960C_PGAIN_2X
	.pgain = APDS9960_PGAIN_2X,
#else
	.pgain = APDS9960_PGAIN_1X,
#endif
#if CONFIG_APDS9960C_AGAIN_64X
	.again = APDS9960_AGAIN_64X,
#elif CONFIG_APDS9960C_AGAIN_16X
	.again = APDS9960_AGAIN_16X,
#elif CONFIG_APDS9960C_AGAIN_4X
	.again = APDS9960_AGAIN_4X,
#else
	.again = APDS9960_AGAIN_1X,
#endif
#if CONFIG_APDS9960C_PPULSE_LENGTH_32US
	.ppcount = APDS9960_PPULSE_LENGTH_32US |
		   (CONFIG_APDS9960C_PPULSE_COUNT - 1),
#elif CONFIG_APDS9960C_PPULSE_LENGTH_16US
	.ppcount = APDS9960_PPULSE_LENGTH_16US |
		   (CONFIG_APDS9960C_PPULSE_COUNT - 1),
#elif CONFIG_APDS9960C_PPULSE_LENGTH_8US
	...
	.ppcount = APDS9960_PPULSE_LENGTH_4US |
		   (CONFIG_APDS9960C_PPULSE_COUNT - 1),
#endif
#if CONFIG_APDS9960C_PLED_BOOST_300PCT
	.pled_boost = APDS9960_PLED_BOOST_300,
#elif CONFIG_APDS9960C_PLED_BOOST_200PCT
	.pled_boost = APDS9960_PLED_BOOST_200,
#elif CONFIG_APDS9960C_PLED_BOOST_150PCT
